    ...
    function P(aa, ab, X, Z) {
        ...
        if (ae) {
            ...
            var ad = M.ie && M.win ? "ActiveX" : "PlugIn",
                ac = "MMredirectURL=" + encodeURI(window.location).toString().replace(/&/g, "%26") + "&MMplayerType=" +
...
xiuxiu.lightEditor = xiuxiu.lightEditor || {
    url: "/resources/PhotoEditor.swf?version=201410201425",
...
xiuxiu.lightPuzzle = xiuxiu.lightPuzzle || {
    url: "/resources/CollagePlugin.swf?version=201305211645",
...
xiuxiu.richEditor = xiuxiu.richEditor || {
    url: "/resources/Main.swf?v=2.6.106",
...
xiuxiu.daitoutie = xiuxiu.daitoutie || {
    url: "/resources/FacePhoto.swf?version=201304251419",
...
xiuxiu.avatarEditor = xiuxiu.avatarEditor || {
    url: "/resources/avatar.swf?version=201410201414",
...
xiuxiu.batchEditor = xiuxiu.batchEditor || {
    url: "/resources/plugin.swf?version=201405281142",
...
xiuxiu.embedSWF = function (b, c, f, m, e) {
    ...
    if (document.getElementById(xiuxiu.container)) {
        document.getElementById(xiuxiu.container).innerHTML =
            '<p><a href="http://www.adobe.com/go/getflashplayer"><img alt="Get Adobe Flash player" src="http://wwwimages.adobe.com/www.adobe.com/images/shared/download_buttons/get_flash_player.gif"></a></p>'
    }
    ...
    swfobject.embedSWF(a, xiuxiu.container, f, m, g, "/resources/expressInstall.swf", h, l,
        xiuxiu.attributes);
    xiuxiu.swfs.push({
